...
main(int argc, char *argv[])
{
  ...
  for(i = 2; i < argc; i++){
    ...
    1077:	50                   	push   %eax
    1078:	ff 33                	push   (%ebx)
    107a:	68 78 1a 00 00       	push   $0x1a78
    107f:	6a 01                	push   $0x1
  ...
  exit();
    ...
    1090:	51                   	push   %ecx
    1091:	51                   	push   %ecx
    1092:	68 58 1a 00 00       	push   $0x1a58
    1097:	6a 02                	push   $0x2
    ...
    168c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    16b9:	0f b6 92 f0 1a 00 00 	movzbl 0x1af0(%edx),%edx
    ...
    1739:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    17a9:	ff 24 85 98 1a 00 00 	jmp    *0x1a98(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    18b7:	90                   	nop
          s = "(null)";
    18b8:	ba 8e 1a 00 00       	mov    $0x1a8e,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    18d1:	a1 a0 22 00 00       	mov    0x22a0,%eax
{
  ...
  freep = p;
    ...
    1911:	5b                   	pop    %ebx
  freep = p;
    1912:	89 15 a0 22 00 00    	mov    %edx,0x22a0
}
    1918:	5e                   	pop    %esi
    1919:	5f                   	pop    %edi
    191a:	5d                   	pop    %ebp
  ...
  freep = p;
    194c:	89 15 a0 22 00 00    	mov    %edx,0x22a0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    196c:	8b 3d a0 22 00 00    	mov    0x22a0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    19b1:	8b 3d a0 22 00 00    	mov    0x22a0,%edi
  ...
  return freep;
    19df:	8b 15 a0 22 00 00    	mov    0x22a0,%edx
    ...
    1a0c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    1a0f:	89 15 a0 22 00 00    	mov    %edx,0x22a0
}
    ...
    1a1f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1a20:	c7 05 a0 22 00 00 a4 	movl   $0x22a4,0x22a0
    1a27:	22 00 00 
    base.s.size = 0;
    1a2a:	bf a4 22 00 00       	mov    $0x22a4,%edi
    base.s.ptr = freep = prevp = &base;
    1a2f:	c7 05 a4 22 00 00 a4 	movl   $0x22a4,0x22a4
    1a36:	22 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1a39:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    1a3b:	c7 05 a8 22 00 00 00 	movl   $0x0,0x22a8
    1a42:	00 00 00 
    if(p->s.size >= nunits){
