    ...
    100a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  if(argc != 3){
    ...
    1017:	52                   	push   %edx
    1018:	52                   	push   %edx
    1019:	68 48 17 00 00       	push   $0x1748
    101e:	6a 02                	push   $0x2
  ...
  exit();
    ...
    1049:	68 5b 17 00 00       	push   $0x175b
    104e:	6a 02                	push   $0x2
    ...
    137c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    13a9:	0f b6 92 d0 17 00 00 	movzbl 0x17d0(%edx),%edx
    ...
    1429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1499:	ff 24 85 78 17 00 00 	jmp    *0x1778(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    15a7:	90                   	nop
          s = "(null)";
    15a8:	ba 6f 17 00 00       	mov    $0x176f,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15c1:	a1 7c 1a 00 00       	mov    0x1a7c,%eax
{
  ...
  freep = p;
    ...
    1601:	5b                   	pop    %ebx
  freep = p;
    1602:	89 15 7c 1a 00 00    	mov    %edx,0x1a7c
}
    1608:	5e                   	pop    %esi
    1609:	5f                   	pop    %edi
    160a:	5d                   	pop    %ebp
  ...
  freep = p;
    163c:	89 15 7c 1a 00 00    	mov    %edx,0x1a7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    165c:	8b 3d 7c 1a 00 00    	mov    0x1a7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16a1:	8b 3d 7c 1a 00 00    	mov    0x1a7c,%edi
  ...
  return freep;
    16cf:	8b 15 7c 1a 00 00    	mov    0x1a7c,%edx
    ...
    16fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    16ff:	89 15 7c 1a 00 00    	mov    %edx,0x1a7c
}
    ...
    170f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1710:	c7 05 7c 1a 00 00 80 	movl   $0x1a80,0x1a7c
    1717:	1a 00 00 
    base.s.size = 0;
    171a:	bf 80 1a 00 00       	mov    $0x1a80,%edi
    base.s.ptr = freep = prevp = &base;
    171f:	c7 05 80 1a 00 00 80 	movl   $0x1a80,0x1a80
    1726:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    172b:	c7 05 84 1a 00 00 00 	movl   $0x0,0x1a84
    1732:	00 00 00 
    if(p->s.size >= nunits){
