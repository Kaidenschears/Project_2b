...
main(int argc, char *argv[])
{
  ...
  exit();
    ...
    1050:	50                   	push   %eax
    1051:	ff 33                	push   (%ebx)
    1053:	68 7f 17 00 00       	push   $0x177f
    1058:	6a 02                	push   $0x2
    ...
    1064:	52                   	push   %edx
    1065:	52                   	push   %edx
    1066:	68 68 17 00 00       	push   $0x1768
    106b:	6a 02                	push   $0x2
    ...
    139c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    13c9:	0f b6 92 fc 17 00 00 	movzbl 0x17fc(%edx),%edx
    ...
    1449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    14b9:	ff 24 85 a4 17 00 00 	jmp    *0x17a4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    15c7:	90                   	nop
          s = "(null)";
    15c8:	ba 9b 17 00 00       	mov    $0x179b,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15e1:	a1 b4 1a 00 00       	mov    0x1ab4,%eax
{
  ...
  freep = p;
    ...
    1621:	5b                   	pop    %ebx
  freep = p;
    1622:	89 15 b4 1a 00 00    	mov    %edx,0x1ab4
}
    1628:	5e                   	pop    %esi
    1629:	5f                   	pop    %edi
    162a:	5d                   	pop    %ebp
  ...
  freep = p;
    165c:	89 15 b4 1a 00 00    	mov    %edx,0x1ab4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    167c:	8b 3d b4 1a 00 00    	mov    0x1ab4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16c1:	8b 3d b4 1a 00 00    	mov    0x1ab4,%edi
  ...
  return freep;
    16ef:	8b 15 b4 1a 00 00    	mov    0x1ab4,%edx
    ...
    171c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    171f:	89 15 b4 1a 00 00    	mov    %edx,0x1ab4
}
    ...
    172f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1730:	c7 05 b4 1a 00 00 b8 	movl   $0x1ab8,0x1ab4
    1737:	1a 00 00 
    base.s.size = 0;
    173a:	bf b8 1a 00 00       	mov    $0x1ab8,%edi
    base.s.ptr = freep = prevp = &base;
    173f:	c7 05 b8 1a 00 00 b8 	movl   $0x1ab8,0x1ab8
    1746:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    174b:	c7 05 bc 1a 00 00 00 	movl   $0x0,0x1abc
    1752:	00 00 00 
    if(p->s.size >= nunits){
